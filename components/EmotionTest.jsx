...
export const EmotionTestButtons = () => {
  ...
  return (
    <Container>
      ...
      <Button
        css={(theme) => {
          // console.info(theme.breakpoints.up('xs'));
          // console.info(theme.breakpoints.up('sm'));
          // console.info(theme.breakpoints.up('md'));
          // console.info(theme.breakpoints.up('lg'));
          return css`
            background: blue;
      ...
      <Button
        // className='btncls'
        // classes={{
        //   outlinedPrimary: classes2.outlinedPrimary,
        //   outlinedSizeLarge: classes2.outlinedSizeLarge,
        // }}
        // classes={{ ...classes2 }}
        variant='outlined'
        color='primary'
        size='large'
        // className={clsx(classes.veryGreen, classes.veryYellow)}
