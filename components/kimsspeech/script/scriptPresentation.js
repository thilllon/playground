...
export const ScriptPresentation = () => {
  ...
  const scriptLanRef = useRef(null);
  ...
  return (
    <div className={classes.root}>
      ...
      <div className={classes.title}>
        <Button className={classes.titleIcon} component={Link} to='/script'>
          <ArrowBackIcon />
        </Button>
        ...
        <div style={{ float: 'right' }}>
          {!isStart ? (
            <Button
              ...
              style={{ height: '2rem', margin: '0 0.5rem 0 0' }}
            >
              시작
            </Button>
          ) : (
      ...
      <div className={classes.timer}>발표시간 : {time} 초</div>
      <div className={classes.contentTitle}>{scriptTitle}</div>
      <span>
        <span className={classes.content}>{sentence}</span>
      </span>
            ...
            <DialogContent>
              <DialogContentText>
                <div className={classes.content} style={{ margin: 0 }}>
                  실전 점수는 {practicePoint}점이고 총 소요 시간은{' '}
                  {practiceTime}초입니다.
                </div>
