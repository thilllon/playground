...
const useStyles = makeStyles({
  root: {},
  title: { width: '100%', fontSize: '1rem', fontWeight: 'bold' },
...
const ScriptMain = () => {
  ...
  const url = 'http://localhost:3333/script/get-list';
  // const url = 'https://kims-speech.herokuapp.com/script/get-list';
  ...
  return (
    <div className={classes.root}>
      <div className={classes.title}>전체 스크립트 목록</div>
